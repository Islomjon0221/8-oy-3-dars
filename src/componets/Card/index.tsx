...
const TodoApp: React.FC = () => {
  ...
  return (
    <div>
      <div className="max-w-[900px] mx-auto Pt-[50px] pb-5">
                ...
                <div className="modal-box bg-white">
                  ...
                  <div className="forms flex justify-between">
                    <input
                      ...
                      className="input input-primary text-black bg-white w-full max-w-xs"
                    />

                    <button className="btn btn-primary text-white" onClick={addTodo}>
                      Add Todo
                    </button>
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div className="mt-3 flex gap-2">
                        ...
                        <button className="btn btn-primary text-white" onClick={() => editTodo(todo)}>
                          Edit
                        </button>
                      </div>
                    </div>
